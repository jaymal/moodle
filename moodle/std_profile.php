            ...
            <div style="background-color:#0f0f0f; margin-top:5px; margin-bottom:5px ">
                <nav class="nav nav-tabs nav-justified ">
                    ...
                    <ul class="nav nav-pills navFont ">
                        ...
                        <li role="presentation" class="active label label-default"><a href="std_profile.php" class="navFont">Profile</a></li>                        
                        ...
                        <div>                     
                            ...
                            <table>
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    echo'<tr><th width="200">Student Id: </th><td>' . $row["st_id"] . '</td></tr>';
                                    echo'<tr><th>Student Name: </th><td>' . $row["name"] . '</td></tr>';
