            ...
            <div style="background-color:#0f0f0f; margin-top:5px; margin-bottom:5px ">
                <nav class="nav nav-tabs nav-justified ">
                    ...
                    <ul class="nav nav-pills navFont ">
                        ...
                        <li role="presentation" class="label label-default"><a href="dept_entry.php"class="navFont">Available Department</a></li>
                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                echo "<table width='700' ><tr><th>ID</th><th>Department Name</th><th>Building ID </th></tr>"; //table h


                                while ($row = mysqli_fetch_assoc($result)) {
                                    echo '<tr height="60"><td>' . $row["dept_id"] . '</td><td>' . $row["dept_name"]. '</td><td>' . $row["building"];
